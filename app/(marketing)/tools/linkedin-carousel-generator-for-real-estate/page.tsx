...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: config.appUrl + '/tools/linkedin-carousel-generator',
  },
  openGraph: {
    ...
    url: config.appUrl + '/tools/linkedin-carousel-generator',
      ...
      <main className="max-w-5xl mx-auto px-4 py-12 space-y-20">
        ...
        <section className="text-center space-y-4 max-w-3xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight leading-tight">
            LinkedIn Carousel Generator <span className="text-primary">for Real Estate Agents</span>
          </h1>
          <p className="text-lg text-muted-foreground leading-relaxed">
            Create scroll-stopping LinkedIn carousels that showcase listings, market expertise, and
            generate leads, without any design skills. Edit, customise, and download as a PDF in
            minutes.
          </p>
        </section>
        ...
        <section className="space-y-4 max-w-3xl">
          ...
          <p className="text-muted-foreground leading-relaxed">
            A LinkedIn carousel is a multi-page PDF document uploaded as a post. Viewers swipe
            through the pages — making it one of the highest engagement formats on the platform. For
            real estate agents, carousels are the perfect vehicle to share property tours,
            neighbourhood guides, market statistics, buyer/seller tips, and personal branding
            content in a format that drives saves, shares, and inbound leads.
          </p>
          <p className="text-muted-foreground leading-relaxed">
            Unlike static image posts, carousels reward curiosity — each swipe reveals more value,
            increasing the time LinkedIn's algorithm marks your post as engaging. Agents who post
            2-4 carousels per month consistently report higher profile views, connection requests,
            and consultation bookings than those using only text or single-image posts. A dedicated
            LinkedIn carousel generator built for real estate makes it effortless to produce this
            content at scale.
          </p>
        </section>
